...
public class InfiniteStream {
	...
	public static void main(String[] args) {
		...
		Stream<UUID> generate = Stream.generate(uuid);
		List<UUID> list = generate.limit(10).skip(15).collect(Collectors.toList());
		...
		System.out.println("------------------------");
		Stream<String> strm = Stream.<String>builder().add("vishal").add("karam").build();
		...
		IntStream isc = IntStream.rangeClosed(0, 5);
